<?php
	...
	require_once get_theme_file_path( 'includes/posts/advisor-names.php' );
	...
	require_once get_theme_file_path( 'includes/wordpress/legacy-redirects.php' );
	...
	require_once get_theme_file_path( 'includes/plugins/booking-confirmation.php' );
	...
	require_once get_theme_file_path( 'includes/admin/getpassword.php' );
