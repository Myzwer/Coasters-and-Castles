...
For full theme documentation, setup notes, system references, and maintenance details, use the main Pre-Launch WP
repository:
...
Global site content, such as logos, social links, footer content, contact information, and fallback images, usually
lives in **ACF Globals**.
...
This client site may not match the starter theme exactly. It began from Pre-Launch WP, but project-specific changes may
have been made during development.

Use this repo as the source of truth for this client site. Use the Pre-Launch WP repo as the source of truth for the
starter theme.
