<?php
	...
	/*
	 * Gravity Forms is rendered directly by this template rather than through
	 * post content. Enqueue its assets before wp_head() so the form does not
	 * briefly render without its final styling/behavior.
	 */
